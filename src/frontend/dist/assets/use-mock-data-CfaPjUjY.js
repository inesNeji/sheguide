import { r as reactExports, j as jsxRuntimeExports } from "./index-DNNoM-aw.js";
...
var DeadlineStatus = /* @__PURE__ */ ((DeadlineStatus2) => {
  DeadlineStatus2["urgent"] = "urgent";
  DeadlineStatus2["upcoming"] = "upcoming";
  DeadlineStatus2["completed"] = "completed";
  return DeadlineStatus2;
})(DeadlineStatus || {});
var Stage = /* @__PURE__ */ ((Stage2) => {
  Stage2["arrival"] = "arrival";
  Stage2["settling"] = "settling";
  Stage2["professional"] = "professional";
  return Stage2;
})(Stage || {});
var VisaType = /* @__PURE__ */ ((VisaType2) => {
  VisaType2["blueCard"] = "blueCard";
  VisaType2["student"] = "student";
  VisaType2["generalResidence"] = "generalResidence";
  return VisaType2;
})(VisaType || {});
const mockBuddies = [
  {
...
const mockDeadlines = [
  {
    ...
    description: "Register your address at the local Bürgeramt within 2 weeks of moving in. Required for almost everything else.",
    dueDate: "2026-04-25",
    stage: Stage.arrival,
  ...
  },
  {
    ...
    description: "Apply for a temporary residence permit while your main visa application is being processed.",
    dueDate: "2026-04-28",
    stage: Stage.arrival,
    status: DeadlineStatus.urgent,
  ...
  },
  {
    ...
    description: "Enroll in a statutory health insurance (Gesetzliche Krankenversicherung) within 3 months of arrival.",
    dueDate: "2026-05-15",
  ...
  },
  {
    ...
    description: "Submit your EU Blue Card application at the Ausländerbehörde with your employment contract and qualification certificates.",
    dueDate: "2026-05-30",
    stage: Stage.arrival,
    status: DeadlineStatus.upcoming,
  ...
  },
  {
    ...
    description: "Register with the German tax office (Finanzamt) to receive your tax ID and set up your ELSTER online account.",
    dueDate: "2026-06-10",
  ...
  },
  {
    ...
    description: "Open a German bank account (Girokonto) — required for salary payments, rent, and direct debits.",
    dueDate: "2026-03-10",
    stage: Stage.settling,
  ...
  },
  {
    ...
    description: "Enroll in an integration course at a certified language school. Required for permanent residence applications.",
    dueDate: "2026-03-20",
    stage: Stage.settling,
    status: DeadlineStatus.completed,
  ...
  },
  {
    ...
    description: "Submit your foreign qualification documents to the relevant German recognition body (anabin database).",
    dueDate: "2026-03-05",
    stage: Stage.professional,
    status: DeadlineStatus.completed,
...
function useBuddies() {
  const topMatches = mockBuddies.slice(0, 3).map((profile, i) => ({
    profile,
    score: BigInt(95 - i * 3)
  }));
  return { buddies: mockBuddies, topMatches };
}
function useDeadlines(_visaType) {
